...
public class ReaderController {
    ...
    public String readerDelete(HttpServletRequest request,RedirectAttributes redirectAttributes){
        ...
        if(success && succ){
            redirectAttributes.addFlashAttribute("succ", "Successfully deleted!");
    ...
    public String readerInfoEditDo(HttpServletRequest request,String name,String sex,String birth,String address,String telcode,RedirectAttributes redirectAttributes){
        ...
        if(!oldName.equals(name)){
            ...
            if(succo&&succ){
                redirectAttributes.addFlashAttribute("succ", "Reader info successfuly updated!");
                return "redirect:/allreaders.html";
            }
            else {
        ...
        if (newPasswd.equals(reNewPasswd)){
            if(passwd.equals(oldPasswd)){
                ...
                if (succ){
                    ...
                    redirectAttributes.addFlashAttribute("succ", "Error occurred while resetting new password... Try again");
                    return "redirect:/reader_repasswd.html";
                }
            ...
            redirectAttributes.addFlashAttribute("error", "Error while entering ew password.");
            return "redirect:/reader_repasswd.html";
        }
 }
    ...
    public String readerInfoAddDo(String name,String sex,String birth,String address,String telcode,int readerId,RedirectAttributes redirectAttributes){
        ...
        //ArrayList<ReaderInfo> readers=readerInfoService.readerInfos();
        if (succ&&succc){
            redirectAttributes.addFlashAttribute("succ", "Reader added successfuly!");
            return "redirect:/allreaders.html";
        }else {
            redirectAttributes.addFlashAttribute("succ", "Error occurred while adding new reader.");
            return "redirect:/allreaders.html";
        }
    }
    ...
    public String readerInfoEditDoReader(HttpServletRequest request,String name,String sex,String birth,String address,String telcode,RedirectAttributes redirectAttributes){
        ...
        if (!readerCard.getName().equals(name)){
            ...
            if(succ&&succo){
                ...
                request.getSession().setAttribute("readercard", readerCardNew);
                redirectAttributes.addFlashAttribute("succ", "ReaderCard updated successfuly!");
                return "redirect:/reader_info.html";
            }else {
                redirectAttributes.addFlashAttribute("error", "Failed to update ReaderCard.");
                return "redirect:/reader_info.html";
            }
        }
        else 
